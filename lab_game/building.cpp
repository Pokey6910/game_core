    ...
    if (enemy == 0) { std:: cout << "Здесь нет таких!\n"; }
        ...
        while (true) {
            ...
            if (enemy -> get_health() <= 0) {
                ...
                std:: cout << player->get_name() << ":: health: " << player->get_health() \
                    << " | iq: " << player->get_iq() << " | power: " << player->get_power() << '\n';
                std:: cout << enemy -> get_name() << ":: health: " << enemy -> get_health() \
